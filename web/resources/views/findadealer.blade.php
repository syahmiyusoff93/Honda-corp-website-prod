...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBFIZDDhBFAH1j3lvDF7OBpxr89HXHN9bE&callback=initMap&loading=async&libraries=marker"></script>
{{-- API key for testing purpose --}}
{{-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBig4OrhpYvDDbCKKprdVRVHkybI5plnkQ&callback=initMap&loading=async&libraries=marker"></script> --}}
...
<script language="javascript">
    ...
    $(document).ready(function(){
        ...
        $('.btn-filter').click(function(){
            $('.search-result').toggleClass('reduced-height');
        })
...
<section class="find-a-dealer">
    <div class="info-container">
        <div class="search-container">
            ...
            <div class="filter-container">
                <div class="btn-filter intro-title more">Filter
                    <div class="button"></div>
                </div>
                <div class="expand-content radio" style="display:none;">
    ...
    {{-- get in touch button --}}
    <a href="https://prebook.honda.com.my/getintouch"><div class="floatingbtn">
        <img src="{{url('img/getintouch/ContactSalesRepv02.svg')}}" alt="">
        <div>Contact Sales <br>Advisor</div>
    </div></a>
...
<style>
    .find-a-dealer .search-result.reduced-height {transition-duration: .5s; height: calc(100vh - 340px - 131px);}
    ...
    .find-a-dealer .info-container .search-container input.input-text {width:82%; display: inline-block;}
    .go-btn { height: 55px; background: red; border:0; color:white; padding:10px 12px;; outline: 0;}
    #map {border-left:2px solid #ccc;}
    .find-a-dealer .search-result {height: calc(100vh - 243px);}
    .find-a-dealer {height: calc(100vh - 70px); border-bottom:1px solid #ccc;}
    .find-a-dealer .search-result.reduced-height {height: calc(100vh - 243px - 131px);}
    ...
    .find-a-dealer .search-result .result-title .location-details .name {font-size: 0.88rem; width: 250px; }
    ...
    .floatingbtn {width:115px;cursor: pointer;z-index: 4;position: fixed;left: 450px;bottom: 15px;text-align: center;font-size: 11px;padding: 10px 0;border: 2px solid #ea1936;border-radius: 10px;background: #fff;}
