...
<section class="content-inner col-workshop-manual">
    ...
    <section class="service-tab-menu">
        ...
        <input type="checkbox" id="service-tab-menu-check">
            ...
            <ul>
                ...
                <li style="border-bottom: 3px solid #e32119;"><a href="{{url('aftersales/service-with-us/customised-workshop')}}">CUSTOMISED WORKSHOP MANUAL</a></li>
    ...
    <div class="inner-content-section content-area">
        <h2>Customised Workshop Manual</h2>
        ...
        <div class="btn-container">
            <a href="{{url('aftersales/service-with-us/team-expert')}}" class="prime-cta-black">
