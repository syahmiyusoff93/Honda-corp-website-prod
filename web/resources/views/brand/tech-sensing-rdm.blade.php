...
<section>
    ...
    <div class="desc-fold maxwidth800">
        <div class="desc-copy">CONFIDENCE IN STAYING ON THE ROAD</div>
        <h2>ROAD DEPARTURE MITIGATION (RDM)</h2>
        <div class="desc-copy">To assist the driver, this feature prevents the vehicle from inadvertently straying off the road.</div><br>
        <div class="desc-copy">Once the vehicle is at speeds above 60km/h, the RDM system operates to provide the driver with 3 types of assistance based on the severity of the circumstance. </div><br>
        <div class="desc-copy">If the vehicle is likely to stray from a detected lane, the monocular camera will detect it and give a visual warning on the display and vibrations on the steering wheel to alert the driver. </div><br>
        <div class="desc-copy">If the vehicle leaves the lane, the steering wheel will vibrate repeatedly within 1.5 seconds to alert the driver and apply corrective steering input to bring the vehicle back into the lane.</div>
        <div class="img-sec img-sec-fullwidth centerdiv">
            <video controls="" autoplay="" name="media" class="w718">
                <source src="{{url('img/technology/02_sensing/02_Videos/rdm.mp4')}}" type="video/mp4">
                    ...
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/cmbs')}}">
                            <div class="details-content">
                                ...
                                <div class="right">Collision Mitigation Braking <br>System (CMBS)</div>
                            </div>
                        </a>
                    </div>
