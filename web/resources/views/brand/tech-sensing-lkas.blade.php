...
<section>
    ...
    <div class="desc-fold maxwidth800">
        ...
        <h2>LANE KEEP ASSIST SYSTEM (LKAS)</h2>
        <div class="desc-copy">The feature will assist in steering to keep the vehicle in the middle of the lane, reducing driver fatigue.</div><br>
        <div class="desc-copy">Upon detection of lane that the vehicle is driving in (detecting solid and broken lines) by the monocular camera, the driver will be warned with vibrations on the steering wheel if the vehicle is likely to stray from the lane. </div>
        <div class="img-sec img-sec-fullwidth centerdiv">
            <video controls="" autoplay="" name="media" class="w718">
                <source src="{{url('img/technology/02_sensing/02_Videos/lkas.mp4')}}" type="video/mp4">
                    ...
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/acc')}}">
                            <div class="details-content">
                                ...
                                <div>Adaptive Cruise Control (ACC)<br> With Low-speed Follow</div>
                            </div>
                        </a>
                    </div>
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/multi-view-camera')}}">
                            <div class="details-content">
                                ...
                                <div class="right">Multi-view Camera System</div>
                            </div>
                        </a>
                    </div>
