...
<section>
    ...
    <div class="desc-fold maxwidth800">
        <div class="desc-copy">LOOKING AHEAD</div>
        <h2>COLLISION MITIGATION BRAKING SYSTEM (CMBS)</h2>
        <div class="desc-copy">To assist the driver in avoiding collisions with oncoming vehicles and pedestrians ahead, the CMBS feature mitigates any damage in the case of collision. </div><br>
        <div class="desc-copy">When the millimetre-wave radar and monocular camera detects a risk of collision, it provides the driver with audio and visual warnings, and the accelerator pedal will vibrate. If the system determines that the collision cannot be avoided, the brakes will automatically be applied. </div><br>
        <div class="desc-copy">When the vehicle strays into an oncoming lane resulting in a possible collision with oncoming vehicles, the system will vibrate the steering wheel to alert the driver, then applying brakes when it determines that the collision is unavoidable. </div>
        <div class="img-sec img-sec-fullwidth centerdiv">
            <video controls="" autoplay="" name="media" class="w718">
                <source src="{{url('img/technology/02_sensing/02_Videos/cmbs.mp4')}}" type="video/mp4">
                    ...
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/rdm')}}">
                            <div class="details-content">
                                ...
                                <div>Road Departure Mitigation <br>(RDM)</div>
                            </div>
                        </a>
                    </div>
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/acc')}}">
                            <div class="details-content">
                                ...
                                <div class="right">Adaptive Cruise Control (ACC)<br> With Low-speed Follow</div>
                            </div>
                        </a>
                    </div>
