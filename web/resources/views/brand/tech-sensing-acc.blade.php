...
<section>
    ...
    <div class="desc-fold maxwidth800">
        <div class="desc-copy">REDUCING DRIVER’S BURDEN</div>
        <h2>ADAPTIVE CRUISE CONTROL (ACC)<br> WITH LOW-SPEED FOLLOW</h2>
        <div class="desc-copy">The feature assists the driver in maintaining an appropriate distance with the vehicle ahead, especially effective on congested highways. </div><br>
        <div class="desc-copy">Distance and speed gap between your vehicle and the vehicle ahead will be detected by the millimetre-wave radar and monocular camera. The system will control acceleration and braking to maintain an appropriate distance. It operates from standstill to high-speed driving modes. </div>
        <div class="img-sec img-sec-fullwidth centerdiv">
            <video controls="" autoplay="" name="media" class="w718">
                <source src="{{url('img/technology/02_sensing/02_Videos/acc.mp4')}}" type="video/mp4">
                    ...
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/cmbs')}}">
                            <div class="details-content">
                                ...
                                <div>Collision Mitigation Braking <br>System (CMBS)</div>
                            </div>
                        </a>
                    </div>
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/lkas')}}">
                            <div class="details-content">
                                ...
                                <div class="right">Lane Keep Assist System (LKAS)</div>
                            </div>
                        </a>
                    </div>
