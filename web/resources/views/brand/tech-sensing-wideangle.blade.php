...
<section>
    ...
    <div class="desc-fold maxwidth800">
        ...
        <h2>WIDE-ANGLE REARVIEW CAMERA SYSTEM</h2>
        <div class="desc-copy">Thanks to the wide-angle rearview camera system, the driver is able to see if there are any obstacles when reverse parking.</div><br>
        <div class="desc-copy">Three display modes are available:</div>
    ...
    {{-- THIS PROBABLY A NEW CONTENT TYPE FOR PAGE BUILDER --}}
        <div class="comp-tabbed-content">
            <div class="tab-nav top-line-gap">
                <ul class="body-copy">
                    <li class="thetab animate" data-target="multiviewcameratab1">Normal View</li>
                    <li class="thetab animate" data-target="multiviewcameratab2">Wide View</li>
                    <li class="thetab animate" data-target="multiviewcameratab3">Top-Down View</li>
                </ul>
            </div>
            ...
            <div class="tab-content">
                <div id="multiviewcameratab1" class="tab-body">
                    <div class="img-sec centerdiv w579">
                        <img src="{{url('img/technology/02_sensing/03_Image/06_NormalView.jpg')}}" alt="">
                        <div class="desc-copy">Standard viewing range offered by typical rearview cameras</div>
                    </div>
                </div>

                <div id="multiviewcameratab2" class="tab-body">
                    <div class="img-sec centerdiv w579">
                        <img src="{{url('img/technology/02_sensing/03_Image/06_WideView.jpg')}}" alt="">
                        <div class="desc-copy">Offers a panoramic view</div>
                    </div>
                </div>

                <div id="multiviewcameratab3" class="tab-body">
                    <div class="img-sec centerdiv w579">
                        <img src="{{url('img/technology/02_sensing/03_Image/06_TopView.jpg')}}" alt="">
                        <div class="desc-copy">Provides an overhead view</div>
                    </div>
                </div>
            </div>
            ...
            <style>
                ...
                .spec-container .tab-slider-trigger, .comp-tabbed-content .thetab {padding:16px 10px; font-size:11px;}
                }
            </style>
                    ...
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/multi-view-camera')}}">
                            <div class="details-content">
                                ...
                                <div>Multi-view Camera System</div>
                            </div>
                        </a>
                    </div>
                    <div class="sensing-footer-col">
                        <a href="{{url('technology/honda-sensing/parking-sensor')}}">
                            <div class="details-content">
                                ...
                                <div class="right">Parking Sensor System</div>
                            </div>
                        </a>
                    </div>
                    <div class="clearfix"></div>
