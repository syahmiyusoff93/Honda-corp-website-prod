        ...
        <section class="content-inner">
            ...
            {{-- THIS PROBABLY A NEW CONTENT TYPE FOR PAGE BUILDER --}}
                <div class="comp-tabbed-content">
                    ...
                    <div class="formsection globalform">
                        {{-- EVERY <ul> IS A ROW --}}
                        <ul class="formrow">
                        ...
                        <div id="careerhonda" class="tab-body">
                            @foreach ($career_list as $item)
                                @if ($item->careerBy=='honda')
                                    <div class="row clisting" data-dept="{{$item->careerDepartment}}" data-loc="{{$item->careerLocation}}">
            ...
            $(document).ready(function(){
                ...
                function runfilter(){
                    ...
                    $('.clisting').each(function(){
                        var deptcheck = (filter_dept=='All Divisions' || $(this).data('dept')==filter_dept) ? true : false;
                        var loccheck = (filter_loc=='All States' || $(this).data('loc')==filter_loc) ? true : false;
                ...
                $('.input-department .dropdown-menu li:first-of-type, .input-location .dropdown-menu li:first-of-type').trigger('click')
            })
        </script>
    </div>
@stop
